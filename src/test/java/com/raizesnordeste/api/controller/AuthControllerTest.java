...
class AuthControllerTest {
    ...
    void loginComSucessoRetornaToken() throws Exception {
        LoginRequest req = new LoginRequest("admin@raizes.com", "admin123");
    ...
    @Test
    void loginComCredenciaisInvalidasRetornaConflito() throws Exception {
        LoginRequest req = new LoginRequest("admin@raizes.com", "senha_errada");
